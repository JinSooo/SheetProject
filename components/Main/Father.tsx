...
import { Input, Checkbox, Menu, Row, theme, Form, Select, Radio, Col } from 'antd'
  ...
  return (
    <Form labelCol={{ span: 8 }} labelWrap wrapperCol={{ span: 14 }}>
      <Row gutter={24}>
        ...
        <Col span={8}>
          <Form.Item label='联系电话' name='联系电话' rules={[{ required: true }]}>
            <Input />
          </Form.Item>
        </Col>
        <Col span={8}>
          <Form.Item label='宝宝常住地址' name='宝宝常住地址' rules={[{ required: true }]}>
        ...
        <Col span={8}>
          <Form.Item label='饮酒：' name='饮酒：' rules={[{ required: true }]}>
            <Radio.Group>
        ...
        <Col span={8}>
          <Form.Item label='家庭年收入' name='家庭年收入' rules={[{ required: true }]}>
            <Select
              style={{ width: 120 }}
              options={[
                { value: '＜8万', label: '＜8万' },
